...
export const SHOW_ATTENTION_NOTIFICATION_CHANNEL = "desktop:show-attention-notification";
export const PICK_ATTENTION_SOUND_CHANNEL = "desktop:pick-attention-sound";
