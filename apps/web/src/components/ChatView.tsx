...
export default function ChatView(props: ChatViewProps) {
  ...
  // The fork's interruption notice is one more work-log entry, so it feeds
  // upstream's projection rather than deriving a timeline of its own.
  const turnInterruptionNotice = useMemo(
    () => deriveTurnInterruptionNotice(activeThread?.latestTurn ?? null),
  ...
  const timelineWorkLogEntries = useMemo(
    ...
    [turnInterruptionNotice, workLogEntries],
  );
