...
import { CLAUDE_OUTPUT_STYLE_OPTION_ID, DEFAULT_CLAUDE_OUTPUT_STYLE } from "./ClaudeProvider.ts";
import {
...
interface ClaudeTurnState {
   ...
   */
  // Fork: mutable, the steering fix clears it when a real message arrives.
  synthetic?: boolean;
