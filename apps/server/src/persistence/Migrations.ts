...
import Migration0055 from "./Migrations/055_ProjectionThreadsGroupKey.ts";
import Migration0056 from "./Migrations/056_ProjectionThreadsParentThreadId.ts";
...
const migrationEntries = [
  ...
  [55, "ProjectionThreadsGroupKey", Migration0055],
  [56, "ProjectionThreadsParentThreadId", Migration0056],
] as const;
